...
When a condition expression references an undefined (Unset) name, the processor does not evaluate the expression. The entire condition block passes through as-is, allowing the implementation to surface or resolve undefined conditions downstream.
